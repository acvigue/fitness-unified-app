...
const mockMessages = computed<ChatMessage[]>(() => {
  ...
  const messages: Record<string, ChatMessage[]> = {
    ...
    '2': [
      msg('1', 'assistant', 'Hey everyone! Just a heads up about this week\'s schedule.', 'Mike Torres'),
      ...
      msg('8', 'assistant', 'Ok trainer says Tuesday can stay at 6, but Thursday has to be 7.', 'Mike Torres'),
    ...
    '3': [
      ...
      msg('9', 'assistant', 'We should do a run together sometime. I\'m trying to get back into it.'),
    ...
    '4': [
      msg('1', 'assistant', 'Good morning everyone! Quick update about tomorrow\'s route.', 'Dana Lee'),
      msg('2', 'assistant', 'The usual path through the park is closed for construction.', 'Dana Lee'),
      msg('3', 'assistant', 'Oh no, that\'s our best route! Any alternatives?', 'Chris Patel'),
      msg('4', 'assistant', 'I scouted a new route yesterday. Goes along the river trail instead.', 'Dana Lee'),
      msg('5', 'user', 'How long is the river trail?'),
      msg('6', 'assistant', 'About 6km. Slightly longer but really scenic.', 'Dana Lee'),
      msg('7', 'assistant', 'I\'ve run that trail before, it\'s great! A bit hilly though.', 'Chris Patel'),
    ...
    <div class="flex-1 min-h-0 overflow-y-auto">
      ...
      >
        <template #content="{ message }">
          <p v-if="isGroup && message.role !== 'user' && (message as any).sender" class="text-xs text-white/50 font-medium mb-0.5">
